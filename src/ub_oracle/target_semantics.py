...
_RUST = TargetPack(
    ...
    class_resolution={
        ...
        "uninit_padding": "safe byte serialization starts from zeroed bytes and writes only fields",
...
_GO = TargetPack(
    ...
    class_resolution={
        ...
        "uninit_padding": "byte slices are explicitly zero-initialized before field serialization",
